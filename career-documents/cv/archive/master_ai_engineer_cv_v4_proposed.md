...
[dave_cropper2003@yahoo.co.uk](mailto:dave_cropper2003@yahoo.co.uk) · [0400 811 545](tel:+61400811545)

LinkedIn: [linkedin.com/in/david-cropper](https://www.linkedin.com/in/david-cropper/) · Portfolio: [journey.chaseriskandcompliance.com.au](https://journey.chaseriskandcompliance.com.au/) · GitHub: [github.com/dcrops](https://github.com/dcrops)
...
AI Engineer applying software engineering discipline to production-minded systems with **Python, FastAPI, Docker, and OpenAI APIs**.
...
- Built modular service architectures with **FastAPI**, containerised deployment with **Docker**, and unit/regression suites in **PyTest**.
...
**Languages & frameworks:** Python · FastAPI · LangChain · Pydantic · Pandas · SQL  
**AI & data:** OpenAI APIs · LLM integration · Embeddings · Vector databases (ChromaDB) · AWS · Databricks  
**Engineering practices:** REST APIs · Docker · Git · PyTest · Unit / regression / behavioural testing · Explainable AI · Human-in-the-loop review · AI evaluation
...
Independently designs and builds AI Engineering systems under a dedicated portfolio brand.
...
Full-time professional development focused initially on modern Data Engineering platforms before progressing into AI Engineering through structured learning and increasingly sophisticated engineering projects.
...
*Master CV v4 (canonical candidate). Prefer the companion HTML for PDF export so URLs remain clickable.*
