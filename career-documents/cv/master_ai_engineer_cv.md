...
[djcropster@gmail.com](mailto:djcropster@gmail.com) · [0400 811 545](tel:+61400811545)
...
**AI Engineering:** OpenAI APIs · LLM integration · LangChain · Embeddings · Vector databases (ChromaDB) · AI evaluation · Explainable AI · Human-in-the-loop  
**Software Engineering:** Python · FastAPI · Pydantic · REST APIs · Docker · Git · PyTest · Unit / regression / behavioural testing  
**Data Engineering:** SQL · Pandas · AWS · Databricks
...
*Canonical Master CV v4. Prefer the companion HTML for PDF export so URLs remain clickable.*
