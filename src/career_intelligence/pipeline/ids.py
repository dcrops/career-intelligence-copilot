"""Minimal ULID helper for pipeline event ids — no extra dependency."""
...
def new_pipeline_event_id() -> str:
    """Return a permanent ``ple_<ULID>`` identifier."""
    return f"ple_{generate_ulid()}"
