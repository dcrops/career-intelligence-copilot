...
| [004](004_opportunity_review_boundary.md) | Opportunity as pre-decision system of record; review queue as derived projection | Accepted (FR-009 M0), implemented (FR-009 M1–M2) — amends ADR-002 persistence boundary |

Related: [04_functional_specification.md](../04_functional_specification.md) § FR-008,
§ FR-009; [10_roadmap.md](../10_roadmap.md) § Horizon 1A.
